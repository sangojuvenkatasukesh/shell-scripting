...
sed -e "s/INSTANCCE_NAME/$INSTANCE_NAME/" -e "s/INSTANCE_IP/$IP" record.json  >/tmp/record.json
aws route53 change-resource-record-sets --hosted-zone-id Z09419003SDE5CZ2II0X0 --change-batch file:///tmp/record.json | jq