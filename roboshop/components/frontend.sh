...
sed -i -e '/catalogue/ s/localhost/172.31.17.86/' -e '/user/ s/localhost/172.31.28.111/' -e '/cart/ s/localhost//' -e '/shipping/ s/localhost/shipping.roboshop.internal/' /etc/nginx/default.d/roboshop.conf &>>$LOG
Status_Check $?
