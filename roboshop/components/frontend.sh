...
sed -i -e '/catalogue/ s/localhost/catalogue.roboshop.internal/' -e '/user/ s/localhost/user.roboshop.internal/' e '/cart/ s/localhost/catalogue.roboshop.internal/'/etc/nginx/default.d/roboshop.conf &>>$LOG
Status_Check $?
